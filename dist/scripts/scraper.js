...
const getOneManga = (mangaId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mangaJson = (0, axios_1.default)(url)
        ...
        const nextReleaseCountdown = (0, utils_1.parseChapterDate)(nextReleaseDate);
        const mangaData = {
            title: title,
...
const getVizData = (mangaId) => __awaiter(void 0, void 0, void 0, function* () {
    const url = `https://www.viz.com/${mangaId}`;
    const vizJson = (0, axios_1.default)(url)
        .then(response => {
        const html = response.data;
        const $ = cheerio_1.default.load(html);
        let recommendedManga = [];
